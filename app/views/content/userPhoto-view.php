    ...
    ?>
        ...
        <div class="columns">
            <div class="column is-two-fifths">
                <?php if (is_file("./app/views/photos/" . $data['usuario_foto'])) { ?>
                    <figure class="image mb-6">
                        <img class="is-rounded" src="<?php echo APP_URL; ?>app/views/photos/<?php echo $data['usuario_foto']; ?>">
                    </figure>
                ...
                <?php } else { ?>
                    <figure class="image mb-6">
                        <img class="is-rounded" src="<?php echo APP_URL; ?>app/views/photos/default.png">
                    </figure>
                <?php } ?>
